      ...
      <section className="mt-6">
        <div>
          <Accordion
            ...
            children="Des sessions privées à votre domicile pour apprendre le bébé signe à votre rythme. Pour une famille (2 parents et bébé)"
            isFirst={true}
          />
          <Accordion
            title="Ateliers bébé signe en collectif "
            children="Ateliers Bébé Signe à votre domicile, mais à plusieurs familles (3 familles maximum). Parfait pour faire des économies et apprendre le bébé signe de façon conviviale."
          />
          <Accordion
