        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col mx-5 md:mx-40 lg:mx-32 mb-8 md:mb-16">
            ...
            <p>
              ...
              fournissez volontairement via notre formulaire de contact. Les
              données collectées incluent votre nom, votre adresse e-mail et
              votre numéro de téléphone. Ces informations sont strictement
              utilisées pour répondre à vos demandes de contact et ne sont
            ...
            <p>
              Notre site n&apos;utilise aucun cookie ni aucun outil de suivi.
              Aucune information de navigation n&apos;est collectée.
            </p>
          </div>
        </div>
