    ...
    <div>
      ...
      <div className=" mx-4 md:mx-20 lg:mx-80">
        ...
        <p className="text-justify  font-jaldi md:text-xl">
          ...
          <em>l'expression des émotions</em>. Ce parcours m'a menée, au fil des
          années, à me spécialiser dans la communication par les signes avec les
          bébés, une merveilleuse passerelle qui permet aux tout-petits de
          communiquer bien avant de savoir parler. Après plusieurs expériences
          professionnelles enrichissantes et étant moi-même devenue maman, j'ai
          décidé de me consacrer entièrement à cette vocation en créant Les
          Mains d'Audrey. Mon objectif est simple : offrir aux parents les
          outils pour renforcer le lien avec leur enfant, grâce à des ateliers
          adaptés et bienveillants, basés sur les signes. Formée par l'Académie
          Éveil et Signes, je me suis aussi nourrie de nombreuses rencontres et
          ...
          guider les familles dans cette belle aventure de communication
          parents-enfant, où chaque signe devient un mot et chaque geste une
